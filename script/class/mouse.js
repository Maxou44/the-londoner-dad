function Mouse() {
	...
	this.gameZoneTactileHaute = false;
	this.gameZoneTactileBasse = false;
	this.gameZoneTactileGauche = false;
	this.gameZoneTactileDroite = false;
	this.bouton = 0;
	this.clic = false;
...
Mouse.prototype.updatePosition = function(event) {
 ...
 while(el=el.offsetParent){
	...
	var scaleToFitX = (window.innerWidth-15) / 640;
	var scaleToFitY = (window.innerHeight-15) / 640;
